...
process.ana.eventExampleVarMin = value #this is where you change the value of the cut variable

process.anaCHS = process.ana.clone(

   jetAK8selParams = defaultAK8CHSJetSelectionParameters.clone(
                         jetExampleVarMin = cms.double($value),  #clone the corresponding selection parameters that contains the cut variable, and change the value here
                         jetExampleVarMax = cms.double($value),
                         ), 
